...
```
**Interval**: `r max_int` or `r time_of_day` with an average of `r max_ave`
...
```
**Number of rows with NA:** `r num_row`
...
**median**: `r median`  
**vs**  
**mean imputed**: ~ `r mean_imp` (rounded to nearest step)  
**median imputed**: `r median_imp` 
